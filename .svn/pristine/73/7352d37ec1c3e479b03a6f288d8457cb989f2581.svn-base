...
public class MapDrawer extends DefaultViewer {
	...
	@Override
	public void redraw(MazePanel panel /*Graphics gc*/, StateGUI state, int px, int py,
	 ...
	 */
	public void draw_map(MazePanel panel/*Graphics gc*/, int px, int py, int walk_step, int view_dx, int view_dy, boolean showMaze, boolean showSolution) {
		...
		for (int y = ymin; y <= ymax; y++)
			for (int x = xmin; x <= xmax; x++) {
				...
				panel.setColor(seencells.hasWall(x,y, CardinalDirection.North) ? Colors.WHITE : Colors.GRAY);
				...
				panel.setColor(seencells.hasWall(x,y, CardinalDirection.West) ? Colors.WHITE : Colors.GRAY);
	...
	public void draw_solution(MazePanel panel, int offx, int offy, int px, int py) {
		...
		//if (panel.getBufferGraphics() == null)
			//System.out.println("panel.getBufferGraphics() is null");
		//else
			//System.out.println("panel.getBufferGraphics() is NOT null");
		
		panel.setColor(Colors.YELLOW);
		
		//System.out.println(panel.getBufferGraphics().getColor());
