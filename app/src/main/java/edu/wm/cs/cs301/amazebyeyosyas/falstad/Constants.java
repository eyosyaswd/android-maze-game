...
public class Constants {
	...
	public static final int VIEW_WIDTH = 625;
	public static final int VIEW_HEIGHT = 625;
	...
	public enum StateGUI { STATE_TITLE, STATE_GENERATING, STATE_PLAY, STATE_LOST, STATE_FINISH }
	// fixing a value matching the escape key
	final static int ESCAPE = 27;
	
	// colors used in classes where awt.Color was removed so that all awt classes were moved to MazePanel
	public enum Colors {BLUE, DARKGRAY, BLACK, WHITE, RED, GRAY, YELLOW, GREEN}
