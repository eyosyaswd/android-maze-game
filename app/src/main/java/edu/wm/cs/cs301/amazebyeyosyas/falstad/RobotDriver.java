 ...
 * Collaborators: Robot
 * 
 * Implementing classes: WallFollower, Wizard, ManualDriver
 * 
 * @author peterkemper
 *
 */
public interface RobotDriver {
    ...
    /**
     * Driver the robot one step closer to the exit
     * @return true if driver successfully reaches thee exit, false otherwise
     * @throws Exception
     */
	boolean drive2ExitOneStep() throws Exception;
