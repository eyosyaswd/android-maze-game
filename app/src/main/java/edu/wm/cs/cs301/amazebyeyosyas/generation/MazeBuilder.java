...
public class MazeBuilder implements Runnable {
	...
	protected void generate() {
		...
		// tells if there is a wall in a direction
		//if (cells.hasWall(0, 0, CardinalDirection.East)) {
			//System.out.println("There is a wall on the east.");
		//}
		//if (cells.hasWall(0, 0, CardinalDirection.North)) {
			//System.out.println("There is a wall on the north.");
		//}
		//if (cells.hasWall(0, 0, CardinalDirection.South)) {
			//System.out.println("There is a wall on the south.");
		//}
		//if (cells.hasWall(0, 0, CardinalDirection.West)) {
			//System.out.println("There is a wall on the west.");
		//}
