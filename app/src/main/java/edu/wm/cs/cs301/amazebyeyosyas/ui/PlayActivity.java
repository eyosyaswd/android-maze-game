...
public class PlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Zoom In Map Button
        Button zoomInButton = (Button) findViewById(R.id.zoom_in);
        zoomInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showToast("Zoom In Map Button Pressed");
                maze.getMazeController().keyDown('+');
            }
        });

        // Zoom Out Map Button
        Button zoomOutButton = (Button) findViewById(R.id.zoom_out);
        zoomOutButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                showToast("Zoom Out Map Button Pressed");
                maze.getMazeController().keyDown('-');
            }
        });
        ...
        if (driver.equals("Manual")) {
            ...
            jumpButton.setOnClickListener(new View.OnClickListener() {
                /**
                 * Jumps forward. Can go through walls.
                 * @param v - the view that was clicked.
                 */
                @Override
                public void onClick(View v) {
                    showToast("Jump Button Pressed");
                    maze.getMazeController().keyDown('w' & 0x1f);
                }
            });
        }
        ...
        if (driver.equals("Manual")) {
            ...
            upButton.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    showToast("Forward Button Pressed");
                    manual.keyDown('k');
                    updateProgressBar();
                    try {
            ...
            downButton.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    showToast("Backward Button Pressed");
                    manual.keyDown('j');
                    updateProgressBar();
                    try {
                        if (manual.drive2Exit()) {
